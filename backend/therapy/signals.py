...
def create_seed_data(sender, **kwargs):
    ...
    sessions = [
        ...
        },
        {
            ...
            "scheduled_start_datetime": timezone.now() - timedelta(days=5),
            "payment_stat": "successful",
            "fee": Decimal("120.00"),
            "status": "completed",
            "duration": 60,
            "therapist_notes": "Excellent session with Bob. Working on anxiety management techniques.",
            "patient_rating": Decimal("4.8"),
            "patient_input": "Really helpful session, feeling much better about managing stress.",
        },
        {
            "id": "s7",
            "therapist_id": "t_abc123",
            ...
            "scheduled_start_datetime": timezone.now() + timedelta(days=7),
            "payment_stat": "pending",
            "fee": Decimal("120.00"),
            "status": "scheduled",
            "duration": 90,
        ...
        # Jane Miller (t_def456) sessions
        {
            ...
            "status": "completed",
            "duration": 60,
            "therapist_notes": "Good progress with Bob. Continuing with CBT techniques.",
            "patient_rating": Decimal("4.5"),
            "patient_input": "Feeling more confident and equipped with coping strategies.",
        },
        {
            "id": "s5",
            "therapist_id": "t_def456",
            ...
            "status": "completed",
            "duration": 45,
            "therapist_notes": "Alice showed great improvement in managing her social anxiety.",
            "patient_rating": Decimal("5.0"),
            "patient_input": "Jane is amazing! I feel so much more confident in social situations.",
        },
        {
            "id": "s8",
            "therapist_id": "t_def456",
            ...
            "patient_first_name": "Charlie",
            "patient_last_name": "Lee",
            "scheduled_start_datetime": timezone.now() + timedelta(days=4),
            "payment_stat": "pending",
            "fee": Decimal("135.00"),
            "status": "scheduled",
            "duration": 60,
        ...
        # Sam Williams (t_ghi789) sessions
        {
            "id": "s3",
        ...
        },
        {
            ...
            "patient_first_name": "Alice",
            "patient_last_name": "Smith",
            "scheduled_start_datetime": timezone.now() - timedelta(days=10),
            "payment_stat": "successful",
            "fee": Decimal("100.00"),
            "status": "completed",
            "duration": 60,
            "therapist_notes": "Initial consultation with Alice went well. Identified key areas to work on.",
            "patient_rating": Decimal("4.2"),
            "patient_input": "Good first session, looking forward to continuing therapy.",
        },
        {
            "id": "s9",
            "therapist_id": "t_ghi789",
            ...
            "patient_first_name": "Bob",
            "patient_last_name": "Johnson",
            "scheduled_start_datetime": timezone.now() + timedelta(days=6),
            "payment_stat": "pending",
            "fee": Decimal("100.00"),
            "status": "scheduled",
            "duration": 45,
